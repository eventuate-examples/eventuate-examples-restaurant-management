package net.chrisrichardson.eventstore.examples.management.restaurant.queryside.redis;
...
import net.chrisrichardson.eventstore.examples.management.restaurant.queryside.common.RestaurantQuerySideService;
import net.chrisrichardson.eventstore.examples.management.restaurant.queryside.util.AvailableRestaurantKeys;
import net.chrisrichardson.eventstore.examples.management.restaurant.queryside.util.RedisEntityKeyFormatter;
